...
public class UploadHandler {
    ...
    public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType) {
        ...
        String params[] = TextUtils.isEmpty(acceptType) ? new String[]{"*/*"} : acceptType.split(";");
    ...
    private void startActivity(Intent intent) {
        try {
            ...
            try {
                ...
                Toast.makeText(activity, "文件上传功能不可用", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private Intent createChooserIntent(Intent... intents) {
        ...
        chooser.putExtra(Intent.EXTRA_TITLE, "选择上传文件的工具");
        return chooser;
    }
